...
typedef struct sbv_i2c_hw_cb_t
{
    ...
    int (*sbv_i2c_master_send_data) (sbv_i2c_instance_t *, uint8_t, sbv_i2c_msg_t, uint8_t*, uint16_t);
    int (*sbv_i2c_master_rcv_data) (sbv_i2c_instance_t *, uint8_t, uint8_t[], uint16_t *);
} sbv_i2c_hw_cb_t;
